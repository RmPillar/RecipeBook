...
function RecipeCard({ recipe }) {
  return (
    <article className='flex flex-col w-full rounded-10 overflow-hidden shadow-md hover:shadow-2xl transition-shadow duration-500'>
        ...
        <div className='flex items-center mb-30'>
          <div className='flex items-center mr-20'>
            ...
            <span className='text-sm font-light'>
              {secondsToTimeString(recipe.duration)}
            </span>
          </div>
