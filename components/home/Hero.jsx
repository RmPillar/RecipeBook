...
function Hero({ data: { heading, tagline }, classes }) {
  return (
    <div
    ...
    >
      <div className='container h-full'>
        <div className='flex flex-col justify-center h-full pb-20 xl:pb-70'>
          {heading && (
            <h1 className='text-5xl lg:text-8xl xl:text-9xl font-extrabold text-white xl:tracking-tight leading-tight mb-20'>
              {heading}
            </h1>
          )}
          {tagline && (
            <h6 className='text-xl lg:text-3xl text-white font-light'>
              {tagline}
            </h6>
          )}
        </div>
